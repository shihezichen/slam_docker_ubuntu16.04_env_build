...
# function: build a slam evnironmen docker image
# author: shihezichen@live.cn

echo ""
echo "This program will build the slam environment docker image with the Dockefile."
echo ""

if [ ! -f "./Dockerfile" ]; then
	echo "Can't find the Dockerfile at the current directory. Exit with 1"
	exit 1
fi
